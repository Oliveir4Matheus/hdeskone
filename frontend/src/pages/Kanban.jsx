...
export default function Kanban() {
  ...
  const ticketsByStatus = (statusName) =>
    tickets.filter((t) => t.status === statusName);
  ...
  const moveTicket = (ticketId, newStatus) => {
    ...
    api.put(`/tickets/${ticketId}`, { status: newStatus }).catch(() => {
      setTickets(prev);
    });
  };
  ...
  const onDragOver = (e, statusName) => {
    e.preventDefault();
    setDropTarget(statusName);
  };
          ...
          return (
            ...
            >
              <div className="kanban-column-header">
                <span
                  className="badge"
                  style={{ background: s.color || "#6b7280", color: "#fff" }}
                >
                  {s.name}
                </span>
                  ...
                  >
                    ...
                    <div className="kanban-card-meta">
                      <span
                        ...
                        style={{
                          background:
                            priorityColors[t.priority] || "#6b7280",
                          color: "#fff",
                          fontSize: "0.65rem",
                        }}
                      >
